...
<template>
	<div
		class="flex flex-wrap h-screen text-center justify-around items-center"
	>
		<div class="font-blod desc">
			<div class="text-7xl code">404</div>
			<div class="text-3xl content" ref="content"
				>The Page</div
			>
			<div
				@click="back"
				active="scale-90 transform"
				class="rounded-lg cursor-pointer transition btn inline-block"
				>👉 Go Home</div
			>
		</div>
